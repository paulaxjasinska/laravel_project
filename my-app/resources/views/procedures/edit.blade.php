    ...
    <div style="margin-top: 100px; min-height: 500px"
        ...
        <form method="POST" action="/procedures/{{$procedure->id}}">
            ...
            <div class="mb-2">
                ...
                <input type="text" id="name" class="form-control" name="name" value="{{$procedure->name}}" />
                @error('title')
            ...
            <div class="mb-2">
                ...
                <textarea id="description" class="form-control" name="description" cols="30"
                    rows="10">{{ $procedure->description }}</textarea>
                @error('description')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-2">
                <label>Price
                    <input type="number" placeholder="0.00" class="form-control mb-2" name="price" min="0"
            ...
            <div class="mb-2">
                ...
                <a href="/procedures/{{$procedure->id}}" class="text-black ml-4"> Back</a>
            </div>
        </form>
    </div>

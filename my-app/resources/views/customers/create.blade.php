...
<body style="background-color: #99CCFF">
    ...
    <form class="row g-3 justify-content-center" style="overflow: hidden;" action="/customers" method="POST">
        @csrf
        <div class="col-md-3">
        ...
        <div class="col-10 d-flex justify-content-center align-items-center">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="phone_number" placeholder="510-390-656"
                        name="phone_number">
                </div>
            </div>
        </div>
